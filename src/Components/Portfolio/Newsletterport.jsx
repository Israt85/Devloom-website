...
const Newsletterport = () => {
    return (
           <div className='w-[1100px] relative  mx-auto rounded-3xl h-[300px] bg-[#FFC310]'>
           ...
           <input className="bg-transparent border-slate-300 border-b-2 w-80 h-10" type="text" name="" id="" placeholder="First Name" />
           <div className="relative mt-4 flex items-end">
           <input className="bg-transparent border-slate-300 border-b-2 w-80 h-10" type="text" name="" id="" placeholder="Email" />
