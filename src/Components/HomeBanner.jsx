...
const HomeBanner = () => {
    return (
        <div className='w-full border flex gap-10 justify-center items-center'>
         <div className='w-[250px] border'>
            ...
            <h1>AboutUs</h1>
            <p>We are a creative agency that offer web and app solutions. We are a creative agency that            offer web and app solutions.We are a creative agencyy  that offer web and 
app solutions forr you at the pocket    
friendly rates.</p>
           </div>   
           <div>
<img className='w-[700px] h-[500px]' src="https://s3-alpha-sig.figma.com/img/7247/926e/23e3424ae4c9f5d0dba367e2b6379a8a?Expires=1732492800&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=nuRfDJoswVPIHbVbYQ5El4-kCKPCDVDacXLSHIeietig-EUIJGnySWUH5rdj3XERWWCW~4eoyldjYJbcqajMdzTQhPCQwp7UEBUTTnpXbQdP4Ik5a4qRaWKIhKlAO76zIWCUXnZZKZoGqo2NsBKkENReJTghjSHL20lsAIcc9qQMc2~ondGpXdcqq7UXlaDXwLtNpSuZx-ztD5d2ZhRRkomiuUD5UyV75Mz0VVY86VFIp2WIsiB4L11MK-PR-Bb1Qhio43vdRYEULebXewUwP8hYKYrpr8yn8KDo2TRIcaXM0YHi8fg4ATgHgvBVAPGhkJJZ43Kf2nZ24u4onwyHgQ__" alt="" />
           </div>
           <div className='w-[300px]'>
           <div className='flex flex-col'>
             <p className='text-7xl'>8.2k</p>
             <p>Trusted Users</p>
