    ...
    return (
        <div className='w-full min-h-screen'>
            <div className='flex lg:flex-row flex-col justify-between mx-10'>
                <p className='lg:w-[500px] text-[#262F68] leading-tight text-3xl lg:text-5xl font-audiowide'>Grocery App development</p>
                <div className='lg:w-[500px] w-full px-2'>
                    <p className='w-full border-b-4 p-4 border-[#FFC310] font-audiowide text-[#262F68]'>Project Type</p>
                    <ul className='flex md:flex-row flex-col flex-wrap gap-4 my-4 justify-center'>
            ...
            <div className='flex md:flex-row flex-col px-2 justify-around my-10 gap-10'>
                <div className='lg:w-[550px] w-full text-[#666666]'>
                ...
                <div>
                    <img className='lg:w-[500px] rounded-2xl lg:h-[450px] w-full h-full' src="https://s3-alpha-sig.figma.com/img/3bc2/a4b8/88af81122574beddeace54cd6d279959?Expires=1734307200&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=nc8JwY4~ILVPgjBb9hNJo-7ywR4~WEOnWf92hQ492BEFNc081-2V2256CXyBkgstJ1wLAGrPFaydaLOWwOOvta1JCp5OgZON11usVTLcZH6ysWPIcYzyaWJlnCdgEdQ7yvX6pWkj7bzZyR-n20pNfEaUI0A7Rg43H1fa-yYdlgkjKyRQum-jgH1MzNnRmUWdRxG1Q4~bssMzd1BHm0z11nhfWB06x3WACeHrYC6CH5K-B7CFxP-v-KdUB7gbm-O3e-8R0PjrgZH9gJm5jW72h7QaSTLuz3bnOAorSoqyMXjDLesPsO2MoeTXHb18~gLxL2uBqq~GBxEVbBdNF9Lp-A__" alt="" />
                </div>
            </div>
