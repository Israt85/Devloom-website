    ...
    return (
        <div className="h-auto w-full">
            <div className="m-10">
                ...
                <p className="text-[300px] font-Inter font-bold text-[#262F68]">Projects</p>
            </div>
            {/* best projects */}
            <div>
                ...
                <div className="flex my-6 justify-center items-center gap-6">
                     <div className="relative">
                        <img className="w-[720px] h-[600px]" src="https://s3-alpha-sig.figma.com/img/f1da/1249/51b02cb9d6dd6425c467784597e2436c?Expires=1733702400&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=CmQwuCPe79~31E2a9WYayXov6kVxB1UsZXC7bllnbjS82daY26Y8rY4cg6JVPygl2N06hbcbuZz0nZCeq0zKJ7q7GpXlcLTvvavSszNmyXzDHLJqsh-vy~W-zUfvUwFo5046bP639UlMsKlVvT1FdiIEjDIR8jBRCPQ8b11wMhhzyOBV9xNaBxOGDpFFO5lj30eY8sJLhU6xYDDjDEZw3S8dFbvvbjS7f8iSYL~S~qAICek7seY7xK6EjEdwjsPTua4wYq1wVwdAwnPTm1aTvxEg8nmIhYhMTz9vu~6dtXwPv8eDNbEHxjx7~N0XEimerOxLzUxi5Fow2vpjylAfhA__" alt="" />
                ...
                {/* fourth part */}
                <div className="w-[1280px] h-[550px] bg-gradient-to-tr from-[#96B7CD] to-[#E68D83]">
                    <div className="flex justify-between">
                        ...
                        <div>
                            <img className="w-[800px] mt-16 h-[490px]" src="https://s3-alpha-sig.figma.com/img/6cce/8469/a4df66008e029b5ab1785d2ba0a9b5fa?Expires=1733702400&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=UWD~rRoY8cyauDvYQWraV37~spi7UmzmJifDgnWi0sXuHdpjeGVf9w-pQxOxUndMU8lY92uv3VBq~3RX3WQsnGVc98IMpLKRkAkPUhWJjcoovO4FhVkrcj2YJ3TQJhAv~diyiWLViQekmXOK0iu4ug0vDvDy1RKOlsMipf7myGUgZiA4jG6iR2ZGv45m4c95Qol-3n~Ihqf4~wJorZEckD9836Ao1akUYcQT188COql6gufzJ-eUW7yMHC~hfCBz3NCBJ66Q8lnTcYFf29nR9c9ofst3t9few55~qlouFcdKtNw52dEhOzlp7eDvmPaU8WWviA7SWFpLcPjaRICgQw__" alt="" />
                        </div>
                    </div>
</div>
...
<div className="flex justify-center my-20 items-center gap-6">
    ...
    <div>
        ...
        <img className="w-[400px] h-[300px] rounded-tl-lg" src="https://s3-alpha-sig.figma.com/img/c4dc/6584/e7db645d8ea6f937efe2e1014a9e1761?Expires=1733702400&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=j~JwMIcuZFuu~d93-lTNScQnJ4vfJ11z9Ia3fx6LwuDnNPY9r~DCYYwrgW-kucDQEJpuWnjeCsBPIlJH6AMzFm9Ccw-2ghMaxUdL7bFT1ptdJfI5dsfxhPQUo4dKztvLNWLt5k~s6SQyojyjkFU5ZbuQJz5aWmspwgMv6Ptus1UH5yBNQdLMAb6pUL0QzfxZyUn-OshPjeGL7F6KNkxuDmC4VgfDPfFptgpGRGLkgBD9yc8SszD27VBAeIgf7mmzi4G1j2BloxFqsvJGJd-2~~Kba1HQs0l-OGQBY9ibu-wWaIZ5rgBOTIhTPmO0IUuQv15BLAfJbNdHiAQCfurO6Q__" alt="" />
    </div>
    <div>
